...
/// Version value for 2.8.0.
pub(crate) const TWO_DOT_EIGHT: Version = Version::new(2, 8, 0);
...
/// Version value for 2.12.1.
pub(crate) const TWO_DOT_TWELVE_DOT_ONE: Version = Version::new(2, 12, 1);
