...
pub enum Error {
    ...
    /// Error in serializing an element of the alloy container's extra environment variables.
    #[snafu(display("Failed to serialize .alloy.alloy.extraEnv {object:?}: {source}"))]
