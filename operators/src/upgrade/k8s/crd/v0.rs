...
impl UpgradeActionSpec{
    ...
    pub fn new(current_version:Option<Version>, target_version:Option<Version>, componens: Option<HashMap<String,Vec<String>>>)-> Self{
        UpgradeActionSpec {
    ...
    pub fn current_version(&self)->Option<Version>{
        self.current_version.as_ref().map(|v| Version::from_str(v).unwrap())
    }

    /// Returns the desired version of the product
    pub fn target_version(&self)->Option<Version>{
        self.target_version.as_ref().map(|v| Version::from_str(v).unwrap())
    }
